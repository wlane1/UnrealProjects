...
#define ORIGINAL_FILE_NAME "UE4Editor-MasteringUnreal.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME MasteringUnreal
#define DEPRECATED_FORGAME DEPRECATED
#define MASTERINGUNREAL_API DLLEXPORT
